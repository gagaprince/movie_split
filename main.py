...
if __name__ == '__main__':
    ...
    print(f"视频尺寸：{video_clip.size}")


    cut_map = [
        [
            [0, 1.64861678], [1, 1], [[0, 0], [0, 0]],
        ],
        [
            [1.64861678, 2.11261678],[1, 2], [[0, 0], [0.2, 0.4]]
        ],
        [
            [2.11261678, 2.57661678], [2, 1.5], [[0.2, 0.4], [-0.1, -0.2]]
        ],
        [
            [2.57661678, 3.04061678], [1.5, 2], [[-0.1, -0.2], [0.3, -0.2]]
        ],
        [
            [3.04061678, 3.50461678], [2, 2], [[0.3, -0.2], [-0.3, 0.2]]
        ],
        [
            [3.50461678, 3.96861678], [2, 1.5], [[-0.3, 0.2], [0, -0.3]]
        ],
        [
            [3.96861678, 4.43261678], [1.5, 1.5], [[0, -0.3], [0, 0]]
        ],
        [
            [4.43261678, 4.8966167800000004], [1.5, 1], [[0, 0], [0.4, -0.4]]
        ],
        [
            [4.8966167800000004, 5.360616780000001], [1, 1.7], [[0.4, -0.4], [0.2, -0.4]]
        ],
        [
            [5.360616780000001, 5.824616780000001], [1.7, 1.4], [[0.2, -0.4], [0, 0]]
        ],
        [
            [5.824616780000001, 6.288616780000002], [1.4, 1.1], [[0, 0], [0, 0]]
        ],
        [
            [6.288616780000002, 6.80344671], [1.1, 1], [[0, 0], [0, 0]]
        ],
        [
            [6.80344671, movie_time], [1, 1], [[0, 0], [0, 0]]
        ]
    ]
    full_clip = movie_curve_change_scale(video_clip, cut_map)
