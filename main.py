...
if __name__ == '__main__':
    ...
    cut_map = [
        ...
        [
            [1.64861678, 2.11261678],[1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [2.11261678, 2.57661678], [1.5, 1], [[0, 0], [0, 0]]
        ],
        [
            [2.57661678, 3.04061678], [1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [3.04061678, 3.50461678], [1.5, 1], [[0, 0], [0, 0]]
        ],
        [
            [3.50461678, 3.96861678], [1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [3.96861678, 4.43261678], [1.5, 1], [[0, 0], [0, 0]]
        ],
        [
            [4.43261678, 4.8966167800000004], [1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [4.8966167800000004, 5.360616780000001], [1.5, 1], [[0, 0], [0, 0]]
        ],
        [
            [5.360616780000001, 5.824616780000001], [1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [5.824616780000001, 6.288616780000002], [1.5, 1], [[0, 0], [0, 0]]
        ],
        [
            [6.288616780000002, 6.80344671], [1, 1.5], [[0, 0], [0, 0]]
        ],
        [
            [6.80344671, 7.29106576], [1.5, 1], [[0, 0], [0, 0]]
        ]
    ]
